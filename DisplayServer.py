...
class DisplayServer(threading.Thread):
	...
	def initializeDisplay(self):
		...
		# # set window coordinate system to approximate boston-area longitude and latitude
		self.displayWindow.setCoords(-71.18,42.20,-70.98,42.45)
	...
	def drawVehicles(self):
		...
		for i in range(self.__numVehicles):
			...
			tailPoint = Point(posX-math.cos((theta))*0.005,
				posY-math.sin((theta))*0.005)
